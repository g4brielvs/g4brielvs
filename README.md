...
I’m Gabriel, a Data Scientist with a passion for uncovering the stories data holds. Previously, I was with the World Bank’s [Development Data Group](https://www.worldbank.org/en/about/unit/unit-dec/dev) 🌍, where I explore the potential of spatial and alternative data to drive meaningful change in global development. Now, I’m with the [Office of the New York State Attorney General](https://ag.ny.gov/), where I apply my expertise in data science to champion justice for all and address some of society’s most pressing challenges.
